...
$tnc = select_data_array($link,'plans','*',"and category='WebHosting'",'','','','');
?>
                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Web Hosting Service Plans</li>
                                </ol>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
								<div class="row">
                                    <div class="col-md-10">
                                        <h4>Web Hosting Service Plans</h4>
                                    </div>
                                    <div class="col-md-2">
...
function save_terms(test1,test2,test3,test4,test5) {
        ...
        $('#detail_t').val('');
        $('#order_t').val('');
        $.post('submit_ajax.php',{title:title,type:type,price:price,status:status,id:id,submit:'submit',pagetype:'web_hosting_plans'},function(response){
            if(response=='exist')
        {
            $('.errordis').show();
            $('.succsdis').hide();
