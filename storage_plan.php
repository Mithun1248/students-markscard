...
$tnc = select_data_array($link,'plans','*'," and category='Storage'",'','','','');
?>
                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Storage Plan</li>
                                </ol>
                            </div>
...
function save_terms(test1,test2,test3,test4,test5) {
        ...
        $('#detail_t').val('');
        $('#order_t').val('');
        $.post('submit_ajax.php',{title:title,type:type,price:price,status:status,id:id,submit:'submit',pagetype:'storage_plans'},function(response){
            if(response=='exist')
        {
            $('.errordis').show();
            $('.succsdis').hide();
